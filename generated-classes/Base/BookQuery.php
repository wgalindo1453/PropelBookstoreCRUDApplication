...
abstract class BookQuery extends ModelCriteria
{
     ...
     * Use the Publisher relation Publisher object
     *
     * @param callable(\PublisherQuery):\PublisherQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \PublisherQuery The inner query object of the NOT EXISTS statement
     */
     ...
     *
     * @return \PublisherQuery The inner query object of the IN statement
     */
     ...
     *
     * @return \PublisherQuery The inner query object of the NOT IN statement
     */
     ...
     * Use the Author relation Author object
     *
     * @param callable(\AuthorQuery):\AuthorQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsQueryCriterion::TYPE_EXISTS or ExistsQueryCriterion::TYPE_NOT_EXISTS
     *
     * @return \AuthorQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \AuthorQuery The inner query object of the NOT EXISTS statement
     */
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \AuthorQuery The inner query object of the IN statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \AuthorQuery The inner query object of the NOT IN statement
     */
